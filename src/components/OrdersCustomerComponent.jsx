...
const OrdersCustomerComponent = ({customer, date, orderId, payment, address}) => {
  return (
    <div>
      <main className='rounded-lg shadow-2xl'>
          <section className="py-24 relative border">
            <div className="max-w-[90%] px-4 md:px-5 lg-6 mx-auto">
                ...
                <h6 className="font-medium text-xl leading-8 text-black mb-3">Hello, {customer}</h6>
                ...
                <div
                    ...
                    <div className="box group">
                        ...
                        <h6 className="font-semibold font-manrope text-2xl leading-9 text-black">{date}</h6>
                    </div>
                    <div className="box group">
                    ...
                    <div className="box group">
                        ...
                        <h6 className="font-semibold font-manrope text-2xl leading-9 text-black">{address}
                        </h6>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-7 w-full pb-6 border-b border-gray-100">
                    ...
                    productName={'Monitor'}
                    quantity={2}
                    image={'img/DALL·E_2024_03_31_20_04_37_Create_an_illustrative_logo_for_EcoPlace (1).webp'}
                    price={300.99} />
                </div>
                ...
                <div className="data ">
                    ...
                    <h6 className="font-manrope font-bold text-2xl leading-9 text-black mb-3">Thank you for shopping
                        with us!</h6>
                    <p className="font-medium text-xl leading-8 text-indigo-600">EcoPlace</p>
                </div>
            </div>
        </section>
