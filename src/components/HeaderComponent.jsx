      ...
      <nav className="bg-white border-gray-200 dark:bg-gray-900 h-full">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="img/DALL·E_2024_03_31_20_04_37_Create_an_illustrative_logo_for_EcoPlace (1).webp" className="h-12 rounded-full" alt="Flowbite Logo" />
          ...
          <div className="flex text-white items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            ...
            <div className={`"z-50 right-11  top-9 absolute block my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown" ${show ? 'block' : 'hidden'}`}>
