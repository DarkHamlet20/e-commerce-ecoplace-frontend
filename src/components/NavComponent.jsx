    ...
    <>
      <nav className="bg-gray-900 smm:h-auto h-36">
        <div className="flex items-center justify-around p-4">
          ...
          <div>
            <ul
              className={`smm:flex md:w-96 right-16 top-24 flex-row smm:bg-transparent rounded bg-gray-800 items-center smm:static absolute md:mt-0 justify-around ${
                drop ? "flex" : "hidden"
              } `}
            >
              <li>
          ...
          <div className="flex relative z-50 text-white items-center space-x-3 md:space-x-0 rtl:space-x-reverse">
            ...
            <div
              className={`"z-50 top-16 right-1 absolute my-4 text-base list-none divide-y  rounded-lg shadow bg-gray-700 divide-gray-600 " id="user-dropdown" ${
                show ? "block" : "hidden"
              }`}
            >
