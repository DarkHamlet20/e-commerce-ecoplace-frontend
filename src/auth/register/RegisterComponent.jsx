                ...
                onSubmit={handleRegister}>
                  {error && <div style={{ color: 'red' }}>{error}</div>}
                    ...
                    <div className='grid grid-cols-2 gap-3'>
                      ...
                      <div>
                            <label htmlFor="street" className="block mb-2 text-sm font-medium text-black">Street</label>
                            <input 
                            id='street'
                            type="text" 
                            name="street" 
                      ...
                      <div>
                          <label htmlFor="country" className="block mb-2 text-sm font-medium text-black">Country</label>
                          <input 
                          id='country'
                          type="text" 
                          name="country" 
                      ...
                      <div className='col-span-2'>
                          <label htmlFor="zip" className="block mb-2 text-sm font-medium text-black">ZIP Code</label>
                          <input 
                    ...
                    <button 
                    type="submit" 
                    className="w-full text-white bg-red-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Sign up</button>
                    <p className="text-sm font-light text-black">
                        Do you have an account? <a href="/login" className="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign in</a>
                    </p>
