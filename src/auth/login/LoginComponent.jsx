                  ...
                  onSubmit={handleSubmit}>
                    {error && <div style={{ color: 'red' }}>{error}</div>}
                      <div>
                          ...
                          name='email' 
                          value={email}
                          className='outline-none bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' placeholder='name@company.com' 
                      ...
                      <div>
                          ...
                          required />
                          <span onClick={() => setShow((prev) => !prev)} className='my-auto rounded-r-lg p-[10px] bg-gray-700 text-white hover:bg-slate-500 transition-all'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                     ...
                     <button 
                      type='submit' 
                      className='w-full text-white bg-red-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 hover:scale-y-110 transition-all'>Sign in</button>
