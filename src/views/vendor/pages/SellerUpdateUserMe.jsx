          ...
          <div className="bg-white rounded-lg shadow-lg p-6 max-w-lg w-full">
            ...
            <form onSubmit={handleUpdate} className="space-y-4">
              ...
              <div className="flex justify-end space-x-4">
                ...
                <button type="button" className="bg-gray-500 text-white py-2 px-4 rounded hover:bg-gray-600" onClick={() => navigate('/seller/account')}>
                  Cancelar
                </button>
              </div>
            </form>
...
export default SellerUpdateUserMe;
